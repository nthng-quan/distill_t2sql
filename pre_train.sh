...
# Pre-train CodeS-1B
# accelerate launch train_causal_lm.py --per_device_train_batch_size 2 --block_size 8192 --seed 42 --pretrained_model_name_or_path bigcode/starcoderbase-1b --epochs 1 --lr 5e-5 --warmup_ratio 0.0 --checkpointing_steps 500 --tensorboard_log_dir ./train_logs/pt-codes-1b --save_all_states True --resume_from_checkpoint True --mode pt --output_ckpt_dir ./ckpts/pt-codes-1b --pt_data_dir ./tokenized_corpus.bin
export CUDA_VISIBLE_DEVICES=1
accelerate launch train_2.py --per_device_train_batch_size 4 --block_size 8192 --seed 42 --pretrained_model_name_or_path bigcode/starcoderbase-1b --epochs 1 --lr 5e-5 --warmup_ratio 0.0 --checkpointing_steps 200 --tensorboard_log_dir ./train_logs/pt-codes-1b --mode pt --output_ckpt_dir ./ckpts/pt-codes-1b --pt_data_dir ./full_tokenized_corpus.bin 
